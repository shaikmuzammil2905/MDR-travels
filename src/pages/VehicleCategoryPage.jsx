...
const vehicleData = {
  '4-seater-cars': {
    ...
    vehicles: [
      { name: "Maruti Suzuki Dzire", type: "4-Seater Sedan", seats: 4, bags: 2, desc: "Comfortable and efficient, perfect for city travel and airport transfers.", ideal: "Airport transfers, couples, small families.", image: "/src/assets/car_dzire.png" },
      { name: "Hyundai Aura", type: "4-Seater Sedan", seats: 4, bags: 2, desc: "Smooth ride with premium interiors for a relaxing journey.", ideal: "Business travel and comfortable city errands.", image: "/src/assets/car_aura.png" },
      { name: "Tata Tigor", type: "4-Seater Sedan", seats: 4, bags: 2, desc: "Safe and sturdy compact sedan for safe local travel.", ideal: "Local sightseeing and short trips.", image: "/src/assets/car_tigor.png" },
      { name: "Hyundai Grand i10 Nios", type: "4-Seater Hatchback", seats: 4, bags: 1, desc: "Compact and agile, great for navigating busy city streets.", ideal: "Quick city commutes and solo travelers.", image: "/src/assets/car_i10.png" }
    ],
    related: [
  ...
  'suvs': {
    ...
    vehicles: [
      { name: "Toyota Innova Crysta", type: "6/7-Seater Premium SUV", seats: 7, bags: 4, desc: "The gold standard for long-distance comfort and reliability.", ideal: "Long-distance trips, family tours.", image: "/src/assets/car_innova.png" },
      { name: "Maruti Suzuki Ertiga", type: "6-Seater MUV", seats: 6, bags: 3, desc: "Spacious and economical for medium-sized family trips.", ideal: "Weekend getaways and family outings.", image: "/src/assets/car_ertiga.png" },
      { name: "Kia Carens", type: "6/7-Seater MUV", seats: 7, bags: 3, desc: "Modern features with comfortable third-row seating.", ideal: "Group trips and comfortable outstation journeys.", image: "/src/assets/car_carens.png" },
      { name: "Mahindra Scorpio", type: "7-Seater SUV", seats: 7, bags: 3, desc: "Rugged and capable for exploring diverse terrains.", ideal: "Hill station trips and robust travel.", image: "/src/assets/car_scorpio.png" }
    ],
    related: [
  ...
  'tempo-travellers': {
    ...
    vehicles: [
      { name: "Force Traveller 12-Seater", type: "Group Traveller", seats: 12, bags: 8, desc: "Spacious group travel with push-back seats and AC.", ideal: "Corporate outings, extended families.", image: "/src/assets/car_force12.png", note: "Available on request" },
      { name: "Premium Force Urbania", type: "Luxury Group Traveller", seats: 17, bags: 10, desc: "Next-generation luxury travel for larger groups.", ideal: "Premium group tours and long-distance travel.", image: "/src/assets/car_urbania.png", note: "Vehicle options subject to availability" }
    ],
    related: [
      { title: '6-7 Seater SUVs', path: '/vehicles/suvs' },
